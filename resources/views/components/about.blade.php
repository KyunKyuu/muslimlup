<section id="tentang" class="relative bg-[#EAE6DF] text-slate-900 overflow-hidden border-t border-slate-400/30">
    
    <!-- Blueprint Grid Overlay Lines (Dark Grid Lines on Cream Background - Pear Image 1 Style) -->
    <div class="absolute inset-0 pointer-events-none z-10">
        <!-- Top Horizontal Blueprint Line -->
            ...
            <div class="lg:col-span-5 space-y-6">
                ...
                <div class="p-6 sm:p-10 rounded-2xl bg-white/90 backdrop-blur-md border border-slate-300 shadow-xl space-y-4 sm:space-y-6 relative overflow-hidden">
                    ...
                    <div class="pt-4 border-t border-slate-200">
                        <span class="inline-block px-3 py-1 rounded-full bg-slate-100 border border-slate-300 text-xs font-mono text-slate-700 font-medium">
