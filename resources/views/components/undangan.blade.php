<section class="relative bg-[#EAE6DF] text-slate-900 overflow-hidden border-t border-slate-400/30 py-16 sm:py-24">
    ...
    <div class="relative z-20 max-w-7xl mx-auto px-8 sm:px-24 w-full">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <!-- Right Side: Person Image Cutout (Controlled size max-h-480px on desktop to fit perfectly) -->
            <div class="lg:col-span-6 flex justify-center lg:justify-end pt-6 lg:pt-0">
                <img src="{{ asset('images/orang_pena_remove.png') }}" 
                     alt="MLUP Undangan Gerakan" 
                     class="h-auto max-h-[320px] sm:max-h-[420px] lg:max-h-[480px] w-auto object-contain">
            </div>
