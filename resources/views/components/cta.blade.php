<section id="hubungi" class="relative py-20 sm:py-28 bg-[#EAE6DF] text-slate-950 overflow-hidden border-t border-slate-400/30">
    ...
    <div class="relative z-20 max-w-5xl mx-auto px-8 sm:px-24 text-center space-y-8">
        ...
        <div class="space-y-4 max-w-3xl mx-auto">
            ...
            <p class="text-slate-800 text-base sm:text-lg font-sans leading-relaxed max-w-2xl mx-auto">
                Hubungi kami lewat Instagram atau WhatsApp. Kami terbuka untuk semua bentuk kolaborasi.
            </p>
        </div>

        <!-- Action Buttons -->
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <a href="https://instagram.com/muslimlup.ac.id" target="_blank" rel="noopener" 
               class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 bg-slate-950 text-white font-bold rounded-xl hover:bg-slate-800 transition-all hover:scale-105 shadow-2xl text-sm tracking-wide">
                <span>Instagram MLUP</span>
